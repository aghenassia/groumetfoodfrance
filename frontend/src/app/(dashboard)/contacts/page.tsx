...
export default function ContactsPage() {
  ...
  const { sortBy, sortDir, companyFilter, commercialFilter, pageSize } = savedFilters;
  ...
  }, [debouncedSearch, companyFilter, commercialFilter, sortBy, sortDir, page, effectivePageSize]);
